  ...
  <xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <xsl:template match="/">
                        ...
                        <tr>
                          ...
                          <tr>
                            ...
                            <td align="left" width="500" height="95%" valign="top" colspan="2">
                              <form action="/shop/shop/order/" method="post">
                                ...
                                <table border="0" width="478">
                                  ...
                                  <xsl:apply-templates select="shop/customer"/>
                                  <tr>
                                  ...
                                  <tr>
                                    <td width="295" bgcolor="#2C2E7B" colspan="4" align="right">
                                      <b>
                                        <font size="2" face="Arial" color="#FFFFFF">
                                          Total
                                        </font>
                                    ...
                                    <td bgcolor="#2C2E7B" align="right" width="83">
                                  ...
                                  <tr>
                                    <td bgcolor="#2C2E7B" align="right" colspan="4">
                                      <font color="#FFFFFF" size="2" face="Arial">
                                        <b>
                                    ...
                                    <td bgcolor="#2C2E7B" align="right">
                                      <INPUT type="checkbox" name="tac"/>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td bgcolor="#2C2E7B" align="center" colspan="5">
                                      <font color="#FFFFFF" size="2" face="Arial">
      ...
      <xsl:template match="customer">
        ...
        <tr>
          <td bgcolor="#EAEAFF" width="67" colspan="2">
            <font size="2" face="Arial">
              Name:
            </font>
          </td>
          <td bgcolor="#EAEAFF" width="146" colspan="3">
            <font size="2" face="Arial">
        ...
        <tr>
          ...
          <td bgcolor="#EAEAFF" width="146" colspan="3">
            <font size="2" face="Arial">
              <xsl:value-of select="deliv_forename"/>  
            </font>
          </td>
        </tr>
        <tr>
          ...
          <td bgcolor="#EAEAFF" width="146" colspan="3">
            <font size="2" face="Arial">
              <xsl:value-of select="deliv_address"/>  
            </font>
          </td>
        </tr>
        <tr>
        ...
        <td bgcolor="#EAEAFF" width="146" colspan="3">
          <font size="2" face="Arial">
            <xsl:value-of select="deliv_city"/>  
          </font>
        </td>
      </tr>
    </xsl:template>
    ...
    <xsl:template match="article">
      ...
      <tr>
        ...
        <td bgcolor="#EAEAFF" align="center" width="45">
          <font size="2" face="Arial">
            <xsl:value-of select="quantity"/> St.
          </font>	
        </td>
